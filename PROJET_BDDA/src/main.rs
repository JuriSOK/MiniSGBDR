...
fn main() {
    ...
    let mut write_buffer1 = ByteBuffer::new();
    let byte_array1 = [1;32]; 
    write_buffer1.write_bytes(byte_array1.as_ref());
    ...
    let mut write_buffer2 = ByteBuffer::new();
    let byte_array2 = [2;32]; 
    write_buffer2.write_bytes(byte_array2.as_ref());
    ...
    let mut write_buffer3 = ByteBuffer::new();
    let byte_array3 = [3;32]; 
    write_buffer3.write_bytes(byte_array3.as_ref());
    ...
    let mut write_buffer4 = ByteBuffer::new();
    let byte_array4 = [4;32]; 
    write_buffer4.write_bytes(byte_array4.as_ref());
    ...
    let mut write_buffer5 = ByteBuffer::new();
    let byte_array5 = [5;32]; 
    write_buffer5.write_bytes(byte_array5.as_ref());
    ...
    let mut write_buffer6 = ByteBuffer::new();
    let byte_array6 = [6;32]; 
    write_buffer6.write_bytes(byte_array6.as_ref());
    ...
    let mut write_buffer7 = ByteBuffer::new();
    let byte_array7 = [5;32]; 
    write_buffer7.write_bytes(byte_array7.as_ref());
